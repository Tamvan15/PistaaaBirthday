...
const animationTimeline = () => {
    ...
    tl.to("#container", 0.6, { visibility: "visible" })
      ...
      .add(startTypeWriter, "+=0.5")
      .from("#fake-btn", 0.3, { scale: 0.2, opacity: 0 })
      .to("#fake-btn", 0.1, { backgroundColor: "rgb(255, 105, 180)" }, "+=5")
      .to("#four", 0.5, { scale: 0.2, opacity: 0, y: -150 }, "+=10")
      ...
      .to("#idea-3\\.5", 0.7, ideaTextTransLeave, "+=1.5")
      ...
      .to("#idea-5", 0.7, { scale: 0.2, opacity: 0 }, "+=1")
      ...
      .staggerFromTo("#baloons img", 2.5, { opacity: 0.9, y: 1400, x: -100 }, { opacity: 1, y: -1000, x: -100 }, 0.2)
